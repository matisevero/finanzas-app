...
export const TIPOS_INGRESO: Record<TipoIngreso, { label: string; color: string; icon: string }> = {
  salario:   { label: 'Salario',    color: '#2D7D2D', icon: '👔' },
...
export const TIPOS_EGRESO: Record<TipoEgreso, { label: string; color: string; bg: string; icon: string }> = {
  ...
  usd:       { label: 'Inversiones USD',color: '#2D7D2D', bg: '#EAF3DE', icon: '💵' },
  ...
  social:    { label: 'Social',         color: '#C0392B', bg: '#FCEBEB', icon: '🎬' },
  expensas:  { label: 'Expensas',       color: '#1D9E75', bg: '#E1F5EE', icon: '🏢' },
  salud:     { label: 'Salud',          color: '#A32D2D', bg: '#FCEBEB', icon: '💊' },
...
export const TIPOS_EVENTO: Record<string, { label: string; color: string; bg: string; icon: string }> = {
  ingreso:  { label: 'Ingreso',    color: '#2D7D2D', bg: '#EAF3DE', icon: '↑'  },
  egreso:   { label: 'Egreso',     color: '#C0392B', bg: '#FCEBEB', icon: '↓'  },
...
export const PALETA_INGRESOS = ['#2D7D2D','#52A852','#85C985','#B8E0B8']
export const PALETA_EGRESOS  = ['#C0392B','#E05A22','#F28B30','#F5B042','#F7C96A','#F9DC95','#E8A598','#D9776C','#C94E42']
...
// ─── Colores para metas ───────────────────────────────────────────────────────
export const META_COLORS = ['#1A5E9E','#C0392B','#2D7D2D','#5B3FA6','#E8A020','#D4537E','#1D9E75','#888780']
